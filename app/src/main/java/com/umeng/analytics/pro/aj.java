...
public class aj implements aq<aj, e>, Serializable, Cloneable {
    ...
    private static final bk p = new bk(IChannel.EXTRA_OPEN_SIGNATURE, (byte) 11, 3);
    ...
    static {
        ...
        enumMap.put((EnumMap) e.SIGNATURE, (e) new bc(IChannel.EXTRA_OPEN_SIGNATURE, (byte) 1, new bd((byte) 11)));
    ...
    public enum e implements ax {
        VERSION(1, "version"),
        ADDRESS(2, "address"),
        SIGNATURE(3, IChannel.EXTRA_OPEN_SIGNATURE),
