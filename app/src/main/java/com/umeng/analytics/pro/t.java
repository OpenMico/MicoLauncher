...
public class t implements x.a {
            ...
            if (sharedPreferences != null && (edit = sharedPreferences.edit()) != null) {
                ...
                if (l) {
                    ...
                    if (FieldManager.allow(b.E)) {
                        UMWorkDispatch.sendEventEx(i, n.a.C, CoreProtocol.getInstance(i), null, 0L);
                    }
                }
                f(context);
                n.a(i).a(false);
    ...
    public boolean b(Context context, long j2, boolean z) {
        ...
        if (j4 > 0 && j5 == 0) {
            ...
            JSONObject jSONObject = new JSONObject();
            if (z) {
                jSONObject.put(d.C0138d.a.g, j3);
            } else {
                jSONObject.put(d.C0138d.a.g, j2);
            }
            ...
            if (FieldManager.allow(b.E)) {
                ...
                jSONObject.put(d.C0138d.a.h, m);
                m = 0L;
            } else {
                jSONObject.put(d.C0138d.a.h, 0L);
            }
    ...
    private void a(Context context, String str, long j2, long j3, long j4) {
        ...
        if (!TextUtils.isEmpty(str) && !str.equals(h)) {
            try {
                JSONObject jSONObject = new JSONObject();
                jSONObject.put(d.C0138d.a.g, j3);
                jSONObject.put(d.C0138d.a.h, j4);
                JSONObject b2 = com.umeng.analytics.b.a().b();
                if (b2 != null && b2.length() > 0) {
                    jSONObject.put("__sp", b2);
                }
        ...
        if (sharedPreferences != null) {
            ...
            try {
                ...
                if (location != null) {
                    ...
                    jSONObject.put(d.C0138d.a.e, jSONObject2);
                }
                ...
                if (i2 != -1) {
                    ...
                    if (longValue > 0 && longValue2 > 0) {
                        ...
                        jSONObject.put(d.C0138d.a.d, jSONObject3);
                    }
