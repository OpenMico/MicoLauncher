...
public class c {
    ...
    public static final String[] aH = {as, at, "_$!du", "_$!c", Y, "_$!sp", b.a.f, "token", "time", "ip", ai.O, "region", "city", "browser", ai.x, ai.F, "device_version", ai.ai, "screen_width", "screen_height", "referrer", "referrer_domain", "initial_referrer", "initial_referrer_domain", "initial_view_time", "search_engine", "keyword", "ali_lib", OneTrack.Param.UTM_SOURCE, OneTrack.Param.UTM_MEDIUM, OneTrack.Param.UTM_TERM, OneTrack.Param.UTM_CONTENT, OneTrack.Param.UTM_CAMPAIGN, Common.DATE, "hour", "minute", "app_version", "sp"};
}
