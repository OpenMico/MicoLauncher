...
public class ImprintHandler implements FileLockCallback {
    ...
    */
    private void e() {
        ...
        L_0x0018:
            r0 = 0
            android.content.Context r2 = com.umeng.commonsdk.statistics.idtracking.ImprintHandler.k     // Catch: Exception -> 0x002d, all -> 0x002b
            java.lang.String r3 = ".imprint"
            java.io.FileInputStream r2 = r2.openFileInput(r3)     // Catch: Exception -> 0x002d, all -> 0x002b
            byte[] r0 = com.umeng.commonsdk.statistics.common.HelperUtils.readStreamToByteArray(r2)     // Catch: Exception -> 0x0029, all -> 0x0058
        L_0x0025:
        ...
        L_0x0033:
            ...
            com.umeng.commonsdk.statistics.proto.d r2 = new com.umeng.commonsdk.statistics.proto.d     // Catch: Exception -> 0x0052, all -> 0x0060
            r2.<init>()     // Catch: Exception -> 0x0052, all -> 0x0060
            com.umeng.analytics.pro.at r3 = new com.umeng.analytics.pro.at     // Catch: Exception -> 0x0052, all -> 0x0060
            r3.<init>()     // Catch: Exception -> 0x0052, all -> 0x0060
            r3.a(r2, r0)     // Catch: Exception -> 0x0052, all -> 0x0060
            r5.i = r2     // Catch: Exception -> 0x0052, all -> 0x0060
            com.umeng.commonsdk.statistics.idtracking.ImprintHandler$a r0 = r5.h     // Catch: Exception -> 0x0052, all -> 0x0060
            r0.a(r2)     // Catch: Exception -> 0x0052, all -> 0x0060
            com.umeng.commonsdk.statistics.proto.d r0 = r5.i     // Catch: Exception -> 0x0052, all -> 0x0060
            com.umeng.commonsdk.statistics.proto.d r0 = r5.d(r0)     // Catch: Exception -> 0x0052, all -> 0x0060
            r5.i = r0     // Catch: Exception -> 0x0052, all -> 0x0060
            goto L_0x0056
        L_0x0052:
            r0 = move-exception
        ...
        L_0x0058:
            ...
            r0 = r4
        L_0x005c:
            com.umeng.commonsdk.statistics.common.HelperUtils.safeClose(r0)     // Catch: all -> 0x0060
