...
public class d implements aq<d, e>, Serializable, Cloneable {
    ...
    private static final bk g = new bk(PropertyService.SUPERTYPE, (byte) 13, 1);
    ...
    static {
        ...
        j.put(ca.class, new C0148d());
        EnumMap enumMap = new EnumMap(e.class);
        enumMap.put((EnumMap) e.PROPERTY, (e) new bc(PropertyService.SUPERTYPE, (byte) 1, new bf((byte) 13, new bd((byte) 11), new bh((byte) 12, e.class))));
    ...
    public enum e implements ax {
        PROPERTY(1, PropertyService.SUPERTYPE),
        VERSION(2, "version"),
        CHECKSUM(3, "checksum");
    ...
    /* loaded from: classes2.dex */
    private static class C0148d implements by {
        private C0148d() {
        }
