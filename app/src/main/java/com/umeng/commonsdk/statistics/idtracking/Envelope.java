...
public class Envelope {
    ...
    public static String getSignature(Context context) {
        ...
        return sharedPreferences.getString(IChannel.EXTRA_OPEN_SIGNATURE, null);
    }
    ...
    public static Envelope genEnvelope(Context context, String str, byte[] bArr) {
        try {
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(context);
            String string = sharedPreferences.getString(IChannel.EXTRA_OPEN_SIGNATURE, null);
            ...
            envelope.seal();
            sharedPreferences.edit().putInt("serial", i + 1).putString(IChannel.EXTRA_OPEN_SIGNATURE, envelope.getSignature()).commit();
    ...
    public void export(Context context) {
        ...
        try {
            ...
            jSONObject.put(IChannel.EXTRA_OPEN_SIGNATURE, hexString);
