...
public class d {
        ...
        if (context != null) {
            ...
            try {
                ...
                if (g != null && g.length() > 0) {
                    jSONObject2.put(InputMethodService.InputPropertyCommand.INPUT_SERVICE_DESC, g);
                }
            } catch (Exception e10) {
    ...
    private static JSONArray k(Context context) {
        ...
        try {
            ActivityManager activityManager = (ActivityManager) context.getApplicationContext().getSystemService(IDMServer.PERSIST_TYPE_ACTIVITY);
    ...
    public static JSONObject f(Context context) {
        ...
        if (context != null) {
            ...
            try {
                ...
                jSONObject.put("s_fs", a.a(applicationContext));
