...
final class u extends TextViewBeforeTextChangeEvent {
    ...
    public String toString() {
        return "TextViewBeforeTextChangeEvent{view=" + this.a + ", text=" + ((Object) this.b) + ", start=" + this.c + ", count=" + this.d + ", after=" + this.e + "}";
    }
