...
public class XiaomiOAuthorize {
    ...
    public XiaomiOAuthorize setPhoneNumAutoFill(Context context, boolean z) {
        return setPhoneNumAutoFill(context, z, SimpleExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
    }
    ...
    /* JADX WARN: Type inference failed for: r5v4, types: [com.xiaomi.account.openauth.XiaomiOAuthorize$4] */
    @Deprecated
            ...
            public void onPostExecute(XiaomiOAuthResults xiaomiOAuthResults) {
                ...
                if (xiaomiOAuthResults == null) {
                    if (this.e == null) {
                        ...
                        bundle2.putString(XiaomiOAuthConstants.EXTRA_ERROR_DESCRIPTION_2, this.e.getMessage());
                    }
                    ...
                    if ("code".equalsIgnoreCase(str2)) {
                        ...
                        bundle2.putString(XiaomiOAuthConstants.EXTRA_ACCESS_TOKEN_2, xiaomiOAuthResults.getAccessToken());
                        bundle2.putString(XiaomiOAuthConstants.EXTRA_EXPIRES_IN_2, xiaomiOAuthResults.getExpiresIn());
