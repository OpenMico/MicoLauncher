    ...
    public static abstract class Stub extends Binder implements IMiPlayClientCallback {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i != 1598968902) {
                ...
                MiPlayDevice miPlayDevice2 = null;
                switch (i) {
                    case 1:
                    ...
                    case 4:
                        parcel.enforceInterface("com.xiaomi.miplay.audioclient.IMiPlayClientCallback");
                        if (parcel.readInt() != 0) {
                            miPlayDevice2 = MiPlayDevice.CREATOR.createFromParcel(parcel);
                        }
                        onDeviceUpdate(miPlayDevice2);
                        parcel2.writeNoException();
                        return true;
                    case 5:
                        parcel.enforceInterface("com.xiaomi.miplay.audioclient.IMiPlayClientCallback");
                    ...
                    case 21:
                        ...
                        onDeviceFoundControlCenter(miPlayDeviceControlCenter2);
                        parcel2.writeNoException();
                        return true;
                    case 22:
                        parcel.enforceInterface("com.xiaomi.miplay.audioclient.IMiPlayClientCallback");
                        ...
                        onDeviceUpdateControlCenter(miPlayDeviceControlCenter);
                        parcel2.writeNoException();
                        return true;
                    case 23:
                        parcel.enforceInterface("com.xiaomi.miplay.audioclient.IMiPlayClientCallback");
                        ...
                        onLocalMediaInfoChange(mediaMetaData);
                        parcel2.writeNoException();
                        return true;
                    default:
        ...
        /* loaded from: classes3.dex */
        public static class a implements IMiPlayClientCallback {
            public static IMiPlayClientCallback a;
            private IBinder b;
        ...
        public static boolean setDefaultImpl(IMiPlayClientCallback iMiPlayClientCallback) {
            if (a.a != null || iMiPlayClientCallback == null) {
                return false;
            }
            a.a = iMiPlayClientCallback;
            return true;
        }
