...
public class HanziToPinyin {
    ...
    private Token a(char c2) {
        ...
        if (c2 < 256) {
            ...
            if (i < 0) {
                ...
                while (i4 <= length) {
                    i = (i4 + length) / 2;
                    i2 = c.compare(ch, Character.toString(a[i]));
                    if (i2 == 0) {
                        break;
                    } else if (i2 > 0) {
                        i4 = i + 1;
    ...
    public ArrayList<Token> get(String str, boolean z) {
