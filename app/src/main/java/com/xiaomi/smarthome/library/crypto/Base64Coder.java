...
public class Base64Coder {
    ...
    /* JADX WARN: Type inference failed for: r5v1, types: [com.xiaomi.smarthome.library.crypto.Base64Coder$OutputStream] */
    /* JADX WARN: Type inference failed for: r5v2, types: [com.xiaomi.smarthome.library.crypto.Base64Coder$OutputStream] */
    /* JADX WARN: Type inference failed for: r5v3 */
    /* JADX WARN: Type inference failed for: r5v4 */
    /* JADX WARN: Type inference failed for: r5v5 */
    /* JADX WARN: Type inference failed for: r5v6, types: [java.io.OutputStream, com.xiaomi.smarthome.library.crypto.Base64Coder$OutputStream] */
    ...
    */
    public static java.lang.String encodeBytes(byte[] r18, int r19, int r20, int r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.smarthome.library.crypto.Base64Coder.encodeBytes(byte[], int, int, int):java.lang.String");
    }
