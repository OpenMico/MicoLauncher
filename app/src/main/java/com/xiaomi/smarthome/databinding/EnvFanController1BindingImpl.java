...
public class EnvFanController1BindingImpl extends EnvFanController1Binding {
    @Nullable
    ...
    static {
        ...
        c.put(R.id.seekView, 7);
    }

    public EnvFanController1BindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 8, b, c));
    }

    private EnvFanController1BindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ConstraintLayout) objArr[0], (ImageView) objArr[3], (ImageView) objArr[6], (ImageView) objArr[5], (VerticalShiftChooser) objArr[7], (TextView) objArr[4], (TextView) objArr[2], (TextView) objArr[1]);
        this.d = -1L;
    ...
    @Override // com.xiaomi.smarthome.databinding.EnvFanController1Binding
    ...
    protected void executeBindings() {
            ...
            if ((j & 1310736) != 0) {
                ...
                if ((j6 & j) != 0) {
                    if (z4) {
                        ...
                        i2 = R.drawable.sh_ic_fan_big_on;
                    } else {
                        imageView = this.ivDevicePic;
                        i2 = R.drawable.sh_ic_fan_big_off;
                    }
        ...
        if (i7 != 0) {
            ...
            if (z2) {
                drawable2 = getDrawableFromResource(this.ivDevicePic, R.drawable.sh_ic_fan_big_offline);
            }
        } else {
            drawable = null;
            str2 = null;
