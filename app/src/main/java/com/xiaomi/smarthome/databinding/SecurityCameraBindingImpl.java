...
public class SecurityCameraBindingImpl extends SecurityCameraBinding {
    @Nullable
    ...
    public SecurityCameraBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 7, b, c));
    }

    private SecurityCameraBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    @Override // com.xiaomi.smarthome.databinding.SecurityCameraBinding
