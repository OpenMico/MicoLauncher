...
public class EnvAirConditionControllerBindingImpl extends EnvAirConditionControllerBinding {
    @Nullable
    ...
    static {
        c.put(R.id.tvTemperature, 6);
        c.put(R.id.ivTempSymbol, 7);
        c.put(R.id.ivConditionMode, 8);
        c.put(R.id.groupTemp, 9);
        c.put(R.id.ivIncrease, 10);
        c.put(R.id.ivDecrease, 11);
        c.put(R.id.ivDragHandle, 12);
    }

    public EnvAirConditionControllerBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 13, b, c));
    }

    private EnvAirConditionControllerBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ConstraintLayout) objArr[0], (Group) objArr[9], (ImageView) objArr[8], (ImageView) objArr[11], (ImageView) objArr[3], (ImageView) objArr[12], (ImageView) objArr[10], (ImageView) objArr[5], (ImageView) objArr[7], (TextView) objArr[4], (TextView) objArr[2], (TextView) objArr[1], (TextView) objArr[6]);
        this.d = -1L;
    ...
    @Override // com.xiaomi.smarthome.databinding.EnvAirConditionControllerBinding
    ...
    protected void executeBindings() {
            ...
            if ((j & 1310736) != 0) {
                ...
                if ((j & j6) != 0) {
                    if (z4) {
                        ...
                        i3 = R.drawable.ic_air_condition_on;
                    } else {
                        imageView = this.ivDevicePic;
                        i3 = R.drawable.sh_ic_air_condition_offline;
                    }
        ...
        if (i7 != 0) {
            ...
            if (z2) {
                drawable = getDrawableFromResource(this.ivDevicePic, R.drawable.sh_ic_air_condition_offline);
            }
        } else {
            drawable2 = null;
            drawable = null;
