...
public class EnvHumidityController1BindingImpl extends EnvHumidityController1Binding {
    @Nullable
    ...
    public EnvHumidityController1BindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 8, b, c));
    }

    private EnvHumidityController1BindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    @Override // com.xiaomi.smarthome.databinding.EnvHumidityController1Binding
