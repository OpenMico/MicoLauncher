...
public class EnvFanController2BindingImpl extends EnvFanController2Binding {
    @Nullable
    ...
    public EnvFanController2BindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 7, b, c));
    }

    private EnvFanController2BindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    @Override // com.xiaomi.smarthome.databinding.EnvFanController2Binding
