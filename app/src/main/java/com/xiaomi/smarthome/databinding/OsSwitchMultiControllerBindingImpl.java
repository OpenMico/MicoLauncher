...
public class OsSwitchMultiControllerBindingImpl extends OsSwitchMultiControllerBinding {
    @Nullable
    ...
    static {
        c.put(R.id.ivDeviceTypePic, 6);
    }

    public OsSwitchMultiControllerBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 7, b, c));
    }

    private OsSwitchMultiControllerBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ConstraintLayout) objArr[0], (ImageView) objArr[6], (ImageView) objArr[4], (RecyclerView) objArr[5], (TextView) objArr[3], (TextView) objArr[2], (TextView) objArr[1]);
        this.d = -1L;
    ...
    @Override // com.xiaomi.smarthome.databinding.OsSwitchMultiControllerBinding
    ...
    protected void executeBindings() {
        ...
        if (i7 != 0) {
            if (i7 != 0) {
                j = z3 ? j | 512 | PlaybackStateCompat.ACTION_PREPARE_FROM_MEDIA_ID : j | 256 | 16384;
            }
            i2 = z3 ? 0 : 8;
            i3 = z3 ? 8 : 0;
        } else {
        ...
        if ((j & 15376) != 0) {
            ...
            if ((j & 15360) != 0) {
                ...
                str2 = ((j & 9216) == 0 || deviceInfo == null) ? null : deviceInfo.deviceName;
                str = ((j & 6144) == 0 || deviceInfo == null) ? null : deviceInfo.roomInfo;
            } else {
                str2 = null;
                str = null;
            }
        ...
        if ((j & 12) != 0) {
            ...
            this.rvStatus.setVisibility(i3);
        }
        if (i8 != 0) {
