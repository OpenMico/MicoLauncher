...
public class EnvHeaterController2BindingImpl extends EnvHeaterController2Binding {
    @Nullable
    ...
    public EnvHeaterController2BindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 7, b, c));
    }

    private EnvHeaterController2BindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    @Override // com.xiaomi.smarthome.databinding.EnvHeaterController2Binding
            ...
            if ((j & 1048656) != 0) {
                ...
                if ((16 & j) != 0) {
                    if (z4) {
                        ...
                        i3 = R.drawable.sh_ic_heater_online_on;
                    } else {
                        imageView = this.ivDevicePic;
                        i3 = R.drawable.sh_ic_heater_online_off;
                    }
