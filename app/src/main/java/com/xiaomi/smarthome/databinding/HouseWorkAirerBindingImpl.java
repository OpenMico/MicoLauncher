...
public class HouseWorkAirerBindingImpl extends HouseWorkAirerBinding {
    @Nullable
    ...
    static {
        ...
        c.put(R.id.ivDown, 7);
        c.put(R.id.ivSwitch, 8);
        c.put(R.id.ivDragHandle, 9);
        c.put(R.id.groupOnline, 10);
    }

    public HouseWorkAirerBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 11, b, c));
    }

    private HouseWorkAirerBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ConstraintLayout) objArr[0], (Group) objArr[10], (ImageView) objArr[7], (ImageView) objArr[9], (ImageView) objArr[3], (ImageView) objArr[6], (ImageView) objArr[8], (ImageView) objArr[5], (TextView) objArr[2], (TextView) objArr[1], (TextView) objArr[4]);
        this.d = -1L;
    ...
    @Override // com.xiaomi.smarthome.databinding.HouseWorkAirerBinding
    ...
    protected void executeBindings() {
        ...
        if (i5 != 0) {
            ...
            if (z3) {
                imageView = this.ivOffline;
                i3 = R.drawable.sh_ic_airer_online;
            } else {
                imageView = this.ivOffline;
                i3 = R.drawable.sh_ic_airer_offline;
            }
