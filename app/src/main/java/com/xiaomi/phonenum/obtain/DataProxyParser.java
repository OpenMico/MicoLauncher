...
public class DataProxyParser extends Parser {
    ...
    private Response a(int i, @NonNull Request request) {
        try {
            Response excute = this.b.createDataHttpClient(i).excute(request);
            Logger logger = this.a;
            logger.d("DataProxy", "data response" + excute);
            return excute;
        } catch (IOException e) {
            this.a.e("DataProxy", "data request", e);
    ...
    private String a(Map<String, List<String>> map) {
        ...
        try {
            ...
            this.a.e("DataProxy", "joinToJson", e);
        }
        return null;
    }
