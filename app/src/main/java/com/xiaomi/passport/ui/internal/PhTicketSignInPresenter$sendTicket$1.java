...
final class PhTicketSignInPresenter$sendTicket$1 extends Lambda implements Function1<String, Unit> {
    ...
    public PhTicketSignInPresenter$sendTicket$1(PhTicketSignInPresenter phTicketSignInPresenter) {
        super(1);
    ...
    public final void invoke2(@NotNull String it) {
        ...
        TrackEventManager.addEvent(StatConstants.STAT_CATEGORY_SMS_REGAIN_SEND_TICKET_SUCCESS);
