...
final class PswSignInPresenter$signInWithAuthCredential$1 extends Lambda implements Function1<AccountInfo, Unit> {
    ...
    public PswSignInPresenter$signInWithAuthCredential$1(PswSignInPresenter pswSignInPresenter, IdPswBaseAuthCredential idPswBaseAuthCredential) {
        super(1);
    ...
    public final void invoke2(@NotNull AccountInfo it) {
        ...
        TrackEventManager.addEvent(StatConstants.STAT_CATEGORY_PASSWORD_LOGIN_SUCCESS);
    }
}
