...
public final class PhoneSmsAuthProvider$trySignInWithAuthCredential$1 extends Lambda implements Function0<RegisterUserInfo> {
    final /* synthetic */ PhoneSmsAuthCredential $authCredential;
    final /* synthetic */ PhoneSmsAuthProvider this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PhoneSmsAuthProvider$trySignInWithAuthCredential$1(PhoneSmsAuthProvider phoneSmsAuthProvider, PhoneSmsAuthCredential phoneSmsAuthCredential) {
        super(0);
