...
final class PhAuthFragment$showCaptcha$1 extends Lambda implements Function2<String, String, Unit> {
    ...
    public PhAuthFragment$showCaptcha$1(PhAuthFragment phAuthFragment, PhoneWrapper phoneWrapper) {
        super(2);
    ...
    public final void invoke2(@NotNull String captchaCode, @NotNull String lastIck) {
        ...
        this.this$0.getPresenter().sendTicket(this.$phone, new CaptchaCode(captchaCode, lastIck));
    }
}
