...
public interface IAccountService extends IInterface {
    void getAuthToken(String str, ICallback iCallback) throws RemoteException;

    /* loaded from: classes2.dex */
    public static abstract class Stub extends Binder implements IAccountService {
        private static final String DESCRIPTOR = "com.xiaomi.miot.support.account.IAccountService";
        ...
        public static IAccountService asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IAccountService)) {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                getAuthToken(parcel.readString(), ICallback.Stub.asInterface(parcel.readStrongBinder()));
        ...
        private static class Proxy implements IAccountService {
            ...
            public void getAuthToken(String str, ICallback iCallback) throws RemoteException {
