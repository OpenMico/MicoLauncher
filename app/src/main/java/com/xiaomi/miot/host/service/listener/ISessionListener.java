...
public interface ISessionListener extends IInterface {
    ...
    void onSucceed(String str, String str2, int i) throws RemoteException;

    /* loaded from: classes2.dex */
    public static abstract class Stub extends Binder implements ISessionListener {
        private static final String DESCRIPTOR = "com.xiaomi.miot.host.service.listener.ISessionListener";
            ...
            if (i != 1598968902) {
                switch (i) {
                    case 1:
                        ...
                        onSucceed(parcel.readString(), parcel.readString(), parcel.readInt());
