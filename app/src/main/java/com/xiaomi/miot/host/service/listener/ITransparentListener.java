...
public interface ITransparentListener extends IInterface {
    void onFailed(MiotError miotError) throws RemoteException;

    void onMessage(String str) throws RemoteException;

    /* loaded from: classes2.dex */
    public static abstract class Stub extends Binder implements ITransparentListener {
        private static final String DESCRIPTOR = "com.xiaomi.miot.host.service.listener.ITransparentListener";
        ...
        public static ITransparentListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface == null || !(queryLocalInterface instanceof ITransparentListener)) {
                return new Proxy(iBinder);
            }
            return (ITransparentListener) queryLocalInterface;
        }
        ...
        /* loaded from: classes2.dex */
        private static class Proxy implements ITransparentListener {
