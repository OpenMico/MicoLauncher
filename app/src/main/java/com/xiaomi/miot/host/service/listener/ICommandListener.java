...
public interface ICommandListener extends IInterface {
    ...
    void onSucceed(String str, String str2) throws RemoteException;

    /* loaded from: classes2.dex */
    public static abstract class Stub extends Binder implements ICommandListener {
        private static final String DESCRIPTOR = "com.xiaomi.miot.host.service.listener.ICommandListener";
            ...
            if (i != 1598968902) {
                switch (i) {
                    case 1:
                        ...
                        onSucceed(parcel.readString(), parcel.readString());
        ...
        private static class Proxy implements ICommandListener {
            ...
            @Override // com.xiaomi.miot.host.service.listener.ICommandListener
            public void onSucceed(String str, String str2) throws RemoteException {
