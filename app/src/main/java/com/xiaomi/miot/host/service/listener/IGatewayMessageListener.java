...
public interface IGatewayMessageListener extends IInterface {
    void onFailed(MiotError miotError) throws RemoteException;

    void onSucceed(String str) throws RemoteException;

    /* loaded from: classes2.dex */
    public static abstract class Stub extends Binder implements IGatewayMessageListener {
        private static final String DESCRIPTOR = "com.xiaomi.miot.host.service.listener.IGatewayMessageListener";
        ...
        public static IGatewayMessageListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IGatewayMessageListener)) {
                return new Proxy(iBinder);
            }
            return (IGatewayMessageListener) queryLocalInterface;
        }
        ...
        /* loaded from: classes2.dex */
        private static class Proxy implements IGatewayMessageListener {
