...
public final class SpanUtils {
    ...
    public SpanUtils setClickSpan(@ColorInt final int i2, final boolean z, final View.OnClickListener onClickListener) {
        ...
        this.F = new ClickableSpan() { // from class: com.xiaomi.micolauncher.common.utils.SpanUtils.1
    ...
    public static class c extends b {
        ...
        private c(Bitmap bitmap, int i) {
            super(i);
            this.b = new BitmapDrawable(MicoApplication.getApp().getResources(), bitmap);
        ...
        @Override // com.xiaomi.micolauncher.common.utils.SpanUtils.b
        public Drawable a() {
            Drawable drawable;
            Exception e;
            ...
            if (this.c != null) {
                try {
                    openInputStream = MicoApplication.getApp().getContentResolver().openInputStream(this.c);
                    bitmapDrawable = new BitmapDrawable(MicoApplication.getApp().getResources(), BitmapFactory.decodeStream(openInputStream));
                } catch (Exception e2) {
                    e = e2;
                }
                try {
                ...
                try {
                    drawable = ContextCompat.getDrawable(MicoApplication.getApp(), this.d);
                    try {
