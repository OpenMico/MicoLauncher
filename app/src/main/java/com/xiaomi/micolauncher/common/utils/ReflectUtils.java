...
public final class ReflectUtils {
    ...
    private void a(List<Constructor<?>> list) {
        Collections.sort(list, new Comparator<Constructor<?>>() { // from class: com.xiaomi.micolauncher.common.utils.ReflectUtils.1
            /* renamed from: a */
    ...
    private void b(List<Method> list) {
        Collections.sort(list, new Comparator<Method>() { // from class: com.xiaomi.micolauncher.common.utils.ReflectUtils.2
            /* renamed from: a */
    ...
    public <P> P proxy(Class<P> cls) {
        ...
        return (P) Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, new InvocationHandler() { // from class: com.xiaomi.micolauncher.common.utils.ReflectUtils.3
