...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static final int[] f = {R.attr.snackbarButtonStyle, R.attr.snackbarTextViewStyle};
    @Nullable
    private final AccessibilityManager c;
    private boolean d;
    @Nullable
    private BaseTransientBottomBar.BaseCallback<Snackbar> g;
    ...
    @NonNull
    private static Snackbar a(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int i) {
        ViewGroup a = a(view);
        if (a != null) {
            if (context == null) {
                context = a.getContext();
            }
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(context).inflate(a(context) ? R.layout.mtrl_layout_snackbar_include : R.layout.design_layout_snackbar_include, a, false);
    ...
    public int getDuration() {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            return this.c.getRecommendedTimeoutMillis(duration, (this.d ? 4 : 0) | 1 | 2);
        } else if (!this.d || !this.c.isTouchExplorationEnabled()) {
            return duration;
        } else {
            return -2;
        }
    ...
    public Snackbar setCallback(@Nullable Callback callback) {
        BaseTransientBottomBar.BaseCallback<Snackbar> baseCallback = this.g;
