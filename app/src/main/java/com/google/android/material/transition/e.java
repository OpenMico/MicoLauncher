...
class e {
    private static final d a = new d() { // from class: com.google.android.material.transition.e.1
    ...
    private static final d b = new d() { // from class: com.google.android.material.transition.e.2
        @Override // com.google.android.material.transition.d
        public f a(float f, float f2, float f3, float f4, float f5, float f6, float f7) {
