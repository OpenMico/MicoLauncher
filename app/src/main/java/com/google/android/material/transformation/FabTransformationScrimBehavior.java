...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private final MotionTiming a = new MotionTiming(75, 150);
    private final MotionTiming b = new MotionTiming(0, 150);
    ...
    private void a(@NonNull View view, boolean z, boolean z2, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimator;
        MotionTiming motionTiming = z ? this.a : this.b;
        if (z) {
            if (!z2) {
                view.setAlpha(0.0f);
            }
