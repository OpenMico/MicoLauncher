...
public class BadgeUtils {
        ...
        toolbar.post(new Runnable() { // from class: com.google.android.material.badge.BadgeUtils.1
            ...
            public void run() {
                ...
                if (actionMenuItemView != null) {
                    BadgeUtils.a(badgeDrawable, Toolbar.this.getResources());
    ...
    static void a(BadgeDrawable badgeDrawable, Resources resources) {
        badgeDrawable.a(resources.getDimensionPixelOffset(R.dimen.mtrl_badge_toolbar_action_menu_item_horizontal_offset));
        badgeDrawable.b(resources.getDimensionPixelOffset(R.dimen.mtrl_badge_toolbar_action_menu_item_vertical_offset));
    }
