...
public final class FlacFrameReader {
    ...
    public static boolean checkAndReadFrameHeader(ParsableByteArray parsableByteArray, FlacStreamMetadata flacStreamMetadata, int i, SampleNumberHolder sampleNumberHolder) {
        ...
        return a((int) ((readUnsignedInt >> 4) & 15), flacStreamMetadata) && b((int) ((readUnsignedInt >> 1) & 7), flacStreamMetadata) && !(((readUnsignedInt & 1) > 1L ? 1 : ((readUnsignedInt & 1) == 1L ? 0 : -1)) == 0) && a(parsableByteArray, flacStreamMetadata, ((j & 1) > 1L ? 1 : ((j & 1) == 1L ? 0 : -1)) == 0, sampleNumberHolder) && a(parsableByteArray, flacStreamMetadata, (int) ((readUnsignedInt >> 12) & 15)) && b(parsableByteArray, flacStreamMetadata, (int) ((readUnsignedInt >> 8) & 15)) && a(parsableByteArray, position);
    }
    ...
    private static boolean a(ParsableByteArray parsableByteArray, FlacStreamMetadata flacStreamMetadata, int i) {
    ...
    private static boolean b(ParsableByteArray parsableByteArray, FlacStreamMetadata flacStreamMetadata, int i) {
    ...
    private static boolean a(ParsableByteArray parsableByteArray, int i) {
