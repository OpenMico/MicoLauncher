    ...
    public static final class Event {
        ...
        public static Event b(ParsableByteArray parsableByteArray) {
            ...
            if (!z4) {
                ...
                j2 = z5 ? parsableByteArray.readUnsignedInt() : C.TIME_UNSET;
                if (!z5) {
            ...
            return new Event(readUnsignedInt, z4, z3, z, arrayList, j2, z2, j, i3, i2, i);
        }
        ...
        public void b(Parcel parcel) {
            ...
            for (int i = 0; i < size; i++) {
                this.componentSpliceList.get(i).c(parcel);
            }
