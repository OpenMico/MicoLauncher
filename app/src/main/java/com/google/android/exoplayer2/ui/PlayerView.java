...
public class PlayerView extends FrameLayout implements AdViewProvider {
    ...
    private boolean n;
    @Nullable
    private PlayerControlView.VisibilityListener o;
    private boolean p;
    @Nullable
    private Drawable q;
    private int r;
    ...
    public PlayerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            try {
                ...
                i8 = obtainStyledAttributes.getResourceId(R.styleable.PlayerView_player_layout_id, i8);
        ...
        if (playerControlView2 != null) {
            playerControlView2.addVisibilityListener(this.a);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes2.dex */
    public final class a implements View.OnClickListener, View.OnLayoutChangeListener, Player.Listener, PlayerControlView.VisibilityListener {
        ...
        public void onTracksChanged(TrackGroupArray trackGroupArray, TrackSelectionArray trackSelectionArray) {
            Player player = (Player) Assertions.checkNotNull(PlayerView.this.m);
