...
public final class Mp3Extractor implements Extractor {
    ...
    private boolean t;
    private long u;
    public static final ExtractorsFactory FACTORY = $$Lambda$Mp3Extractor$hqKod4YBonTOYwcNhXjNd4GBNw8.INSTANCE;
    private static final Id3Decoder.FramePredicate a = $$Lambda$Mp3Extractor$fk8w30HoyQGfUVZejoI_Jx9T2mk.INSTANCE;
