...
public final class MediaCodecInfo {
    ...
    public static MediaCodecInfo newInstance(String str, String str2, String str3, @Nullable MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        return new MediaCodecInfo(str, str2, str3, codecCapabilities, z, z2, z3, !z4 && codecCapabilities != null && a(codecCapabilities) && !c(str), codecCapabilities != null && c(codecCapabilities), z5 || (codecCapabilities != null && e(codecCapabilities)));
    }
    ...
    public boolean isCodecSupported(Format format) {
        ...
        if (Util.SDK_INT <= 23 && MimeTypes.VIDEO_VP9.equals(this.mimeType) && profileLevels.length == 0) {
            profileLevels = h(this.capabilities);
        }
    ...
    public DecoderReuseEvaluation canReuseCodec(Format format, Format format2) {
        ...
        if (this.a) {
            ...
            if (d(this.name) && !format.initializationDataEquals(format2)) {
                i2 |= 2;
            }
            if (i2 == 0) {
    ...
    public boolean isVideoSizeAndRateSupportedV21(int i, int i2, double d) {
        ...
        if (videoCapabilities == null) {
            ...
            if (i >= i2 || !f(this.name) || !a(videoCapabilities, i2, i, d)) {
    ...
    public boolean isAudioChannelCountSupportedV21(int i) {
        ...
        if (audioCapabilities == null) {
            ...
            return false;
        } else if (a(this.name, this.mimeType, audioCapabilities.getMaxInputChannelCount()) >= i) {
            return true;
        } else {
    ...
    private static MediaCodecInfo.CodecProfileLevel[] h(@Nullable MediaCodecInfo.CodecCapabilities codecCapabilities) {
        int i;
        MediaCodecInfo.VideoCapabilities videoCapabilities;
        if (codecCapabilities == null || (videoCapabilities = codecCapabilities.getVideoCapabilities()) == null) {
            i = 0;
