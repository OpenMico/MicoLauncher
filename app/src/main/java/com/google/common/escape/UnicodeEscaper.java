    ...
    protected static int codePointAt(CharSequence charSequence, int i, int i2) {
        ...
        if (i < i2) {
            ...
            if (charAt > 56319) {
                ...
                throw new IllegalArgumentException("Expected low surrogate but got char '" + charAt2 + "' with value " + ((int) charAt2) + " at index " + i3 + " in '" + ((Object) charSequence) + LrcRow.SINGLE_QUOTE);
            }
        } else {
