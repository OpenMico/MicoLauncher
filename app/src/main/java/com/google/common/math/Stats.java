...
public final class Stats implements Serializable {
    ...
    public double populationVariance() {
        ...
        return a.e(this.sumOfSquaresOfDeltas) / count();
    }
    ...
    public double sampleVariance() {
        ...
        return a.e(this.sumOfSquaresOfDeltas) / (this.count - 1);
    }
    ...
    public static double meanOf(Iterator<? extends Number> it) {
        ...
        while (it.hasNext()) {
            ...
            j++;
            doubleValue = (!Doubles.isFinite(doubleValue2) || !Doubles.isFinite(doubleValue)) ? StatsAccumulator.a(doubleValue, doubleValue2) : doubleValue + ((doubleValue2 - doubleValue) / j);
        }
        return doubleValue;
    }
    ...
    public static double meanOf(double... dArr) {
        ...
        for (int i = 1; i < dArr.length; i++) {
            double d2 = dArr[i];
            d = (!Doubles.isFinite(d2) || !Doubles.isFinite(d)) ? StatsAccumulator.a(d, d2) : d + ((d2 - d) / (i + 1));
        }
        return d;
    }
