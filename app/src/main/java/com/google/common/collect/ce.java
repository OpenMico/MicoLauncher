...
class ce<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ce(Table.Cell<R, C, V> cell) {
    ...
    public ImmutableSet<Table.Cell<R, C, V>> a() {
        return ImmutableSet.of(a(this.singleRowKey, this.singleColumnKey, this.singleValue));
    }
