...
abstract class f extends Number {
    ...
    static {
        try {
            g = a();
            h = g.objectFieldOffset(f.class.getDeclaredField(BuildConfig.FLAVOR));
            i = g.objectFieldOffset(f.class.getDeclaredField("busy"));
        } catch (Exception e) {
            throw new Error(e);
        }
    }
    ...
    */
    final void a(long r17, int[] r19, boolean r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.cache.f.a(long, int[], boolean):void");
    }
    ...
    public static Unsafe a() {
        try {
            ...
            return (Unsafe) AccessController.doPrivileged(new PrivilegedExceptionAction<Unsafe>() { // from class: com.google.common.cache.f.1
                /* renamed from: a */
