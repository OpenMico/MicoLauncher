...
final class a {
    ...
    private static Version a(BitMatrix bitMatrix) throws FormatException {
    ...
    public byte[] b() throws FormatException {
        ...
        while (true) {
            if (i3 == height && i == 0 && !z) {
                ...
                if (i3 == i4 && i == 0 && (width & 3) != 0 && !z2) {
                    i2++;
                    bArr[i2] = (byte) b(height, width);
                    i3 -= 2;
                    i += 2;
                    z2 = true;
                } else if (i3 == height + 4 && i == 2 && (width & 7) == 0 && !z3) {
                    i2++;
                    bArr[i2] = (byte) c(height, width);
                    i3 -= 2;
                    i += 2;
                    z3 = true;
                } else if (i3 == i4 && i == 0 && (width & 7) == 4 && !z4) {
                    i2++;
                    bArr[i2] = (byte) d(height, width);
                    i3 -= 2;
                    i += 2;
                    z4 = true;
                } else {
                    do {
                        if (i3 < height && i >= 0 && !this.b.get(i, i3)) {
                            i2++;
                            bArr[i2] = (byte) b(i3, i, height, width);
                        }
                        i3 -= 2;
                        i += 2;
                        if (i3 < 0) {
                    ...
                    do {
                        if (i5 >= 0 && i6 < width && !this.b.get(i6, i5)) {
                            i2++;
                            bArr[i2] = (byte) b(i5, i6, height, width);
                        }
                        i5 += 2;
                        i6 -= 2;
                        if (i5 >= height) {
        ...
        if (i2 == this.c.getTotalCodewords()) {
            return bArr;
        }
        throw FormatException.getFormatInstance();
    }
