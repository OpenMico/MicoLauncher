...
public final class RSS14Reader extends AbstractRSSReader {
    ...
    private static final int[] c = {0, Opcodes.IF_ICMPLT, 961, 2015, 2715};
    private static final int[] d = {0, 336, AnalyticsListener.EVENT_PLAYER_RELEASED, 1516};
    ...
    private DataCharacter a(BitArray bitArray, FinderPattern finderPattern, boolean z) throws NotFoundException {
        ...
        if (z) {
            ...
            int i15 = (10 - i11) / 2;
            int i16 = f[i15];
            return new DataCharacter((RSSUtils.getRSSvalue(evenCounts, 9 - i16, false) * b[i15]) + RSSUtils.getRSSvalue(oddCounts, i16, true) + d[i15], i12);
        }
    }
    ...
    private FinderPattern a(BitArray bitArray, int i, boolean z, int[] iArr) throws NotFoundException {
        int i2;
        int i3;
