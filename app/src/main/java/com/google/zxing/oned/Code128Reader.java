...
public final class Code128Reader extends OneDReader {
            ...
            if (bitArray.get(nextSet) != z) {
                ...
                if (i == 5) {
                    ...
                    for (int i4 = 103; i4 <= 105; i4++) {
                        float patternMatchVariance = patternMatchVariance(iArr, a[i4], 0.7f);
    ...
    /* JADX WARN: Removed duplicated region for block: B:87:0x0185 A[PHI: r19 
      PHI: (r19v7 boolean) = (r19v8 boolean), (r19v8 boolean), (r19v8 boolean), (r19v10 boolean), (r19v10 boolean), (r19v10 boolean) binds: [B:71:0x013b, B:76:0x014d, B:75:0x0147, B:45:0x00c7, B:50:0x00da, B:49:0x00d3] A[DONT_GENERATE, DONT_INLINE]] */
