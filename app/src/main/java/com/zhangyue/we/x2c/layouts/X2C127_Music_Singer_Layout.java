...
public class X2C127_Music_Singer_Layout implements IViewCreator {
    ...
    public View createView(Context context) {
        ...
        frameLayout.setBackgroundResource(R.drawable.singer_bg_first);
        frameLayout.setLayoutParams(layoutParams);
        frameLayout.setPadding(0, (int) resources.getDimension(R.dimen.radio_padding_top), 0, 0);
