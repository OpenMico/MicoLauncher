    ...
    static {
        ...
        try {
            ...
            if (resourceAsStream != null) {
                ...
                i3 = Integer.parseInt(properties.getProperty("org.conscrypt.version.major", DataModel.CIRCULATEFAIL_NO_SUPPORT));
                try {
                    i = Integer.parseInt(properties.getProperty("org.conscrypt.version.minor", DataModel.CIRCULATEFAIL_NO_SUPPORT));
                    try {
                        i2 = Integer.parseInt(properties.getProperty("org.conscrypt.version.patch", DataModel.CIRCULATEFAIL_NO_SUPPORT));
                        i3 = i3;
