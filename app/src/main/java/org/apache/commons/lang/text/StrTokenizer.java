...
public class StrTokenizer implements Cloneable, ListIterator {
    ...
    */
    private int a(char[] r9, int r10, int r11, org.apache.commons.lang.text.StrBuilder r12, java.util.List r13) {
        /*
            r8 = this;
        L_0x0000:
        ...
        L_0x0060:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.lang.text.StrTokenizer.a(char[], int, int, org.apache.commons.lang.text.StrBuilder, java.util.List):int");
    }

    private int a(char[] cArr, int i, int i2, StrBuilder strBuilder, List list, int i3, int i4) {
        strBuilder.clear();
        boolean z = i4 > 0;
        int i5 = i;
        int i6 = 0;
