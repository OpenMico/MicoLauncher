    ...
    */
    private static int a(int r5, int r6) {
        ...
        L_0x0066:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.lang3.math.Fraction.a(int, int):int");
    }
    ...
    public String toString() {
        if (this.b == null) {
            this.b = getNumerator() + "/" + getDenominator();
        }
        return this.b;
    }
                ...
                if (i == i2) {
                    ...
                    if (i < (-this.denominator)) {
                        ...
                        if (properNumerator == 0) {
                            ...
                            this.c = getProperWhole() + StringUtils.SPACE + properNumerator + "/" + getDenominator();
                        }
                    } else {
                        this.c = getNumerator() + "/" + getDenominator();
                    }
                }
            }
        }
