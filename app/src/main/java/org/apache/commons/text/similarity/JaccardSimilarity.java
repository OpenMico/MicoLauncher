...
public class JaccardSimilarity implements SimilarityScore<Double> {
    ...
    public Double apply(CharSequence charSequence, CharSequence charSequence2) {
        if (charSequence != null && charSequence2 != null) {
            return Double.valueOf(Math.round(a(charSequence, charSequence2).doubleValue() * 100.0d) / 100.0d);
        }
        throw new IllegalArgumentException("Input cannot be null");
    }

    private Double a(CharSequence charSequence, CharSequence charSequence2) {
