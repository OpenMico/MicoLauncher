...
public class StrSubstitutor {
    ...
    private int a(StrBuilder strBuilder, int i, int i2, List<String> list) {
        ...
        int i6 = i;
        while (i6 < i3) {
            int isMatch = variablePrefixMatcher.isMatch(cArr, i6, i, i3);
            if (isMatch != 0) {
                if (i6 > i) {
                    int i7 = i6 - 1;
                ...
                while (true) {
                    if (i9 >= i3) {
                        ...
                        i6 = i9;
                        break;
                    } else if (!isEnableSubstitutionInVariables || variablePrefixMatcher.isMatch(cArr, i9, i, i3) == 0) {
                        ...
                        if (isMatch2 == 0) {
                            ...
                            variableSuffixMatcher = variableSuffixMatcher;
                            escapeChar = escapeChar;
                            String str = new String(cArr, i8, (i9 - i6) - isMatch);
                            ...
                            if (valueDelimiterMatcher != null) {
                                ...
                                z = z;
                                for (int i11 = 0; i11 < charArray.length && (isEnableSubstitutionInVariables || variablePrefixMatcher.isMatch(charArray, i11, i11, charArray.length) == 0); i11++) {
                                    if (valueDelimiterMatcher.isMatch(charArray, i11) != 0) {
                                        int isMatch3 = valueDelimiterMatcher.isMatch(charArray, i11);
                                        String substring = str.substring(0, i11);
                                        resolveVariable = str.substring(i11 + isMatch3);
                                        str = substring;
                                        break;
                                    }
                                }
                        ...
                        i10++;
                        i9 += variablePrefixMatcher.isMatch(cArr, i9, i, i3);
                    }
                }
            } else {
                i6++;
