...
public class EntityArrays {
    ...
    static {
        ...
        hashMap.put("þ", "&thorn;");
        hashMap.put("ÿ", "&yuml;");
        ISO8859_1_ESCAPE = Collections.unmodifiableMap(hashMap);
        ...
        hashMap2.put("›", "&rsaquo;");
        hashMap2.put("€", "&euro;");
        HTML40_EXTENDED_ESCAPE = Collections.unmodifiableMap(hashMap2);
        HTML40_EXTENDED_UNESCAPE = Collections.unmodifiableMap(invert(HTML40_EXTENDED_ESCAPE));
        HashMap hashMap3 = new HashMap();
        hashMap3.put("\"", "&quot;");
        hashMap3.put(MusicGroupListActivity.SPECIAL_SYMBOL, "&amp;");
        hashMap3.put("<", "&lt;");
        hashMap3.put(">", "&gt;");
        BASIC_ESCAPE = Collections.unmodifiableMap(hashMap3);
        BASIC_UNESCAPE = Collections.unmodifiableMap(invert(BASIC_ESCAPE));
        HashMap hashMap4 = new HashMap();
        hashMap4.put(LrcRow.SINGLE_QUOTE, LrcRow.APOS);
        APOS_ESCAPE = Collections.unmodifiableMap(hashMap4);
        ...
        JAVA_CTRL_CHARS_ESCAPE = Collections.unmodifiableMap(hashMap5);
