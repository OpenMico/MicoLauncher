        ...
        try {
            if (function1 != null) {
                ...
                if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    probeCoroutineCreated.resumeWith(Result.m1220constructorimpl(invoke));
                    return;
                }
                return;
            }
            ...
            probeCoroutineCreated.resumeWith(Result.m1220constructorimpl(ResultKt.createFailure(th)));
        }
    }
