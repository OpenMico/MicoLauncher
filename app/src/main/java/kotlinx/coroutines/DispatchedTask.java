        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                    cancellationException = StackTraceRecoveryKt.a(cancellationException2, (CoroutineStackFrame) continuation);
                    continuation.resumeWith(Result.m1220constructorimpl(ResultKt.createFailure(cancellationException)));
                }
                cancellationException = cancellationException2;
                continuation.resumeWith(Result.m1220constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m1220constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core);
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m1220constructorimpl(successfulResult$kotlinx_coroutines_core));
            }
            ...
            try {
                ...
                obj = Result.m1220constructorimpl(Unit.INSTANCE);
            } catch (Throwable th3) {
                th = th3;
                Result.Companion companion5 = Result.Companion;
                obj = Result.m1220constructorimpl(ResultKt.createFailure(th));
                handleFatalException(th2, Result.m1223exceptionOrNullimpl(obj));
            }
        } catch (Throwable th4) {
            try {
                ...
                obj2 = Result.m1220constructorimpl(ResultKt.createFailure(th5));
            }
            handleFatalException(null, Result.m1223exceptionOrNullimpl(obj2));
            throw th4;
        }
        handleFatalException(th2, Result.m1223exceptionOrNullimpl(obj));
    }
