...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    @Deprecated
    @NotNull
    private static final Symbol f = new Symbol("UNDEFINED");
    @Deprecated
    @NotNull
    private static final c<Object> g = new c<>(f, null);
    private static final /* synthetic */ AtomicReferenceFieldUpdater b = AtomicReferenceFieldUpdater.newUpdater(ConflatedBroadcastChannel.class, Object.class, "_state");
    private static final /* synthetic */ AtomicIntegerFieldUpdater c = AtomicIntegerFieldUpdater.newUpdater(ConflatedBroadcastChannel.class, "_updating");
    private static final /* synthetic */ AtomicReferenceFieldUpdater d = AtomicReferenceFieldUpdater.newUpdater(ConflatedBroadcastChannel.class, Object.class, "onCloseHandler");
    ...
    private final void a(Throwable th) {
        ...
        if (obj != null && obj != AbstractChannelKt.HANDLER_INVOKED && d.compareAndSet(this, obj, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public void invokeOnClose(@NotNull Function1<? super Throwable, Unit> function1) {
        ...
        if ((obj2 instanceof a) && d.compareAndSet(this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo1761trySendJP2dKIU(E e2) {
        a a2 = a((ConflatedBroadcastChannel<E>) e2);
        if (a2 == null) {
            return ChannelResult.Companion.m1781successJP2dKIU(Unit.INSTANCE);
        }
        return ChannelResult.Companion.m1779closedJP2dKIU(a2.a());
    }
    ...
    public final <R> void a(SelectInstance<? super R> selectInstance, E e2, Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> function2) {
        if (selectInstance.trySelect()) {
            ...
            if (a2 == null) {
                ...
                selectInstance.resumeSelectWithException(a2.a());
            }
        }
    }
