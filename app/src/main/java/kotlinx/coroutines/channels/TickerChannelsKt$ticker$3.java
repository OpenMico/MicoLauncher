        ...
        switch (this.label) {
            case 0:
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[this.$mode.ordinal()]) {
                    case 1:
                        this.label = 1;
                        if (TickerChannelsKt.a(this.$delayMillis, this.$initialDelayMillis, producerScope.getChannel(), this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        break;
                    case 2:
                        this.label = 2;
                        if (TickerChannelsKt.b(this.$delayMillis, this.$initialDelayMillis, producerScope.getChannel(), this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        break;
                }
