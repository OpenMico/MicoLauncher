...
final class ah<U, T extends U> extends ScopeCoroutine<T> implements Runnable {
    @JvmField
    public final long a;

    public ah(long j, @NotNull Continuation<? super U> continuation) {
    ...
    public void run() {
        cancelCoroutine(TimeoutKt.TimeoutCancellationException(this.a, this));
    }
