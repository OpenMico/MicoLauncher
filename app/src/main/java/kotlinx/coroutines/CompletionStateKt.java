...
public final class CompletionStateKt {
        ...
        if (th != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    th = StackTraceRecoveryKt.a(th, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
    ...
    public static final <T> Object recoverResult(@Nullable Object obj, @NotNull Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m1220constructorimpl(ResultKt.createFailure(th));
        }
        Result.Companion companion2 = Result.Companion;
        return Result.m1220constructorimpl(obj);
    }
}
