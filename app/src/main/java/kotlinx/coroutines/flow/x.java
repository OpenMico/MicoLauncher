...
public final class x<T> implements CancellableFlow<T>, StateFlow<T>, FusibleFlow<T> {
    ...
    public x(@NotNull StateFlow<? extends T> stateFlow, @Nullable Job job) {
        this.a = job;
        this.b = stateFlow;
    }
