...
public final class w<T> implements CancellableFlow<T>, SharedFlow<T>, FusibleFlow<T> {
    ...
    public w(@NotNull SharedFlow<? extends T> sharedFlow, @Nullable Job job) {
        this.a = job;
        this.b = sharedFlow;
    }
