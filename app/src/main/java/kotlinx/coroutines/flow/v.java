...
public final /* synthetic */ class v {
        ...
        */
        public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r6) {
            ...
            L_0x001d:
                ...
                kotlin.jvm.functions.Function3<T1, T2, kotlin.coroutines.Continuation<? super R>, java.lang.Object> r2 = r5.$transform
                r3 = 0
                r3 = r6[r3]
                r4 = 1
                r6 = r6[r4]
                r5.L$0 = r1
                r5.label = r4
                java.lang.Object r6 = r2.invoke(r3, r6, r5)
            ...
            L_0x003c:
                ...
                r3 = 2
                r5.label = r3
                java.lang.Object r6 = r1.emit(r6, r2)
    ...
    @NotNull
    public static final <T1, T2, R> Flow<R> a(@NotNull Flow<? extends T1> flow, @NotNull Flow<? extends T2> flow2, @BuilderInference @NotNull Function4<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super Continuation<? super Unit>, ? extends Object> function4) {
    ...
    @NotNull
    public static final <T1, T2, R> Flow<R> b(@NotNull Flow<? extends T1> flow, @NotNull Flow<? extends T2> flow2, @BuilderInference @NotNull Function4<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super Continuation<? super Unit>, ? extends Object> function4) {
    ...
    @NotNull
    public static final <T1, T2, T3, R> Flow<R> a(@NotNull Flow<? extends T1> flow, @NotNull Flow<? extends T2> flow2, @NotNull Flow<? extends T3> flow3, @BuilderInference @NotNull final Function4<? super T1, ? super T2, ? super T3, ? super Continuation<? super R>, ? extends Object> function4) {
        ...
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1
            ...
            public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
                ...
                b2 = v.b();
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr2, b2, new AnonymousClass2(null, function4), continuation);
            ...
            public static final class AnonymousClass2 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
                ...
                @Nullable
                public final Object invoke(@NotNull FlowCollector<? super R> flowCollector, @NotNull Object[] objArr, @Nullable Continuation<? super Unit> continuation) {
                    AnonymousClass2 r0 = new AnonymousClass2(continuation, this.$transform$inlined);
                ...
                */
                public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r8) {
                    ...
                    L_0x001e:
                        ...
                        kotlin.jvm.functions.Function4 r3 = r7.$transform$inlined
                        r4 = 0
                        r4 = r8[r4]
                        r5 = 1
                        r6 = r8[r5]
                        ...
                        java.lang.Object r8 = r3.invoke(r4, r6, r8, r7)
                        r3 = 7
    ...
    @NotNull
    public static final <T1, T2, T3, R> Flow<R> a(@NotNull Flow<? extends T1> flow, @NotNull Flow<? extends T2> flow2, @NotNull Flow<? extends T3> flow3, @BuilderInference @NotNull Function5<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super T3, ? super Continuation<? super Unit>, ? extends Object> function5) {
    ...
    @NotNull
    public static final <T1, T2, T3, T4, R> Flow<R> a(@NotNull Flow<? extends T1> flow, @NotNull Flow<? extends T2> flow2, @NotNull Flow<? extends T3> flow3, @NotNull Flow<? extends T4> flow4, @NotNull final Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super Continuation<? super R>, ? extends Object> function5) {
        ...
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2
            ...
            public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
                ...
                Flow[] flowArr2 = flowArr;
                b2 = v.b();
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr2, b2, new AnonymousClass2(null, function5), continuation);
                return combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? combineInternal : Unit.INSTANCE;
            }
    ...
    @NotNull
    public static final <T1, T2, T3, T4, T5, R> Flow<R> a(@NotNull Flow<? extends T1> flow, @NotNull Flow<? extends T2> flow2, @NotNull Flow<? extends T3> flow3, @NotNull Flow<? extends T4> flow4, @NotNull Flow<? extends T5> flow5, @NotNull final Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super Continuation<? super R>, ? extends Object> function6) {
        ...
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3
            ...
            public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
                ...
                Flow[] flowArr2 = flowArr;
                b2 = v.b();
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr2, b2, new AnonymousClass2(null, function6), continuation);
                return combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? combineInternal : Unit.INSTANCE;
            }
    ...
    public static final /* synthetic */ Flow a(Iterable iterable, @BuilderInference Function3 function3) {
        Object[] array = CollectionsKt.toList(iterable).toArray(new Flow[0]);
        if (array != null) {
    ...
    @NotNull
    public static final <T1, T2, R> Flow<R> a(@NotNull final Flow<? extends T1> flow, @NotNull final Flow<? extends T2> flow2, @NotNull final Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3) {
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$1
            ...
            public Object collect(@NotNull FlowCollector<? super R> flowCollector, @NotNull Continuation<? super Unit> continuation) {
                ...
                b2 = v.b();
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, b2, new v.a(function3, null), continuation);
                return combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? combineInternal : Unit.INSTANCE;
            }
        };
    }

    public static final /* synthetic */ Flow a(Flow[] flowArr, Function2 function2) {
