...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2 implements Flow<R> {
    ...
    public Object collect(@NotNull FlowCollector<? super R> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        ...
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, new FlowKt__ZipKt$combine$5$1(this.a), new FlowKt__ZipKt$combine$5$2(this.b, null), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, new FlowKt__ZipKt$combine$5$1(this.a), new FlowKt__ZipKt$combine$5$2(this.b, null), continuation);
        InlineMarker.mark(1);
