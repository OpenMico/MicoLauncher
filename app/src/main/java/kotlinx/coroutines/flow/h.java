...
public final /* synthetic */ class h {
    ...
    public static final <T> Job a(@NotNull Flow<? extends T> flow, @NotNull CoroutineScope coroutineScope) {
        Job a2;
        a2 = e.a(coroutineScope, null, null, new a(flow, null), 3, null);
        return a2;
    }
    ...
    @Nullable
    public static final <T> Object a(@NotNull Flow<? extends T> flow, @NotNull Function3<? super Integer, ? super T, ? super Continuation<? super Unit>, ? extends Object> function3, @NotNull Continuation<? super Unit> continuation) {
    ...
    public static final <T> Object b(@NotNull Flow<? extends T> flow, @NotNull Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> function2, @NotNull Continuation<? super Unit> continuation) {
        Flow a2;
        a2 = j.a(FlowKt.mapLatest(flow, function2), 0, null, 2, null);
        Object collect = FlowKt.collect(a2, continuation);
        return collect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? collect : Unit.INSTANCE;
    }

    @Nullable
    public static final <T> Object a(@NotNull FlowCollector<? super T> flowCollector, @NotNull Flow<? extends T> flow, @NotNull Continuation<? super Unit> continuation) {
