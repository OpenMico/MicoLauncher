...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(@NotNull FlowCollector<? super R> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        ...
        Flow[] flowArr = this.a;
        b = v.b();
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, b, new FlowKt__ZipKt$combineUnsafe$1$1(this.b, null), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        b = v.b();
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, b, new FlowKt__ZipKt$combineUnsafe$1$1(this.b, null), continuation);
        InlineMarker.mark(1);
