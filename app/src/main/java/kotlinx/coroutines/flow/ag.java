...
public final class ag<T> implements SharedFlow<T> {
    @NotNull
    ...
    public ag(@NotNull SharedFlow<? extends T> sharedFlow, @NotNull Function2<? super FlowCollector<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        this.a = sharedFlow;
        this.b = function2;
    }
