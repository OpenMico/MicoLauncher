...
public final class c<T> extends ChannelFlow<T> {
    private static final /* synthetic */ AtomicIntegerFieldUpdater c = AtomicIntegerFieldUpdater.newUpdater(c.class, "consumed");
    @NotNull
    ...
    protected ChannelFlow<T> create(@NotNull CoroutineContext coroutineContext, int i, @NotNull BufferOverflow bufferOverflow) {
        return new c(this.a, this.b, coroutineContext, i, bufferOverflow);
    }
    ...
    protected Object collectTo(@NotNull ProducerScope<? super T> producerScope, @NotNull Continuation<? super Unit> continuation) {
        Object b = FlowKt__ChannelsKt.b(new SendingCollector(producerScope), this.a, this.b, continuation);
    ...
    public Object collect(@NotNull FlowCollector<? super T> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        if (this.capacity == -3) {
            a();
            Object b = FlowKt__ChannelsKt.b(flowCollector, this.a, this.b, continuation);
            return b == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? b : Unit.INSTANCE;
        }
    ...
    protected String additionalToStringProps() {
        return Intrinsics.stringPlus("channel=", this.a);
    }
}
