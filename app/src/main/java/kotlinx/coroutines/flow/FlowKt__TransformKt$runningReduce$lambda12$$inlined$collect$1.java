...
public final class FlowKt__TransformKt$runningReduce$lambda12$$inlined$collect$1 implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$runningReduce$lambda-12$$inlined$collect$1", f = "Transform.kt", i = {0}, l = {TsExtractor.TS_STREAM_TYPE_DTS, 140}, m = "emit", n = {"this"}, s = {"L$0"})
    ...
    */
    public java.lang.Object emit(T r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r6 = this;
            boolean r0 = r8 instanceof kotlinx.coroutines.flow.FlowKt__TransformKt$runningReduce$lambda12$$inlined$collect$1.AnonymousClass1
        ...
        L_0x006c:
            r8.element = r7
            kotlinx.coroutines.flow.FlowCollector r7 = r2.c
