...
public class d<T> extends ChannelFlow<T> {
    @NotNull
    private final Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> a;
    ...
    public /* synthetic */ d(Function2 function2, EmptyCoroutineContext emptyCoroutineContext, int i, BufferOverflow bufferOverflow, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    protected ChannelFlow<T> create(@NotNull CoroutineContext coroutineContext, int i, @NotNull BufferOverflow bufferOverflow) {
        return new d(this.a, coroutineContext, i, bufferOverflow);
    }

    static /* synthetic */ Object a(d dVar, ProducerScope producerScope, Continuation continuation) {
        Object invoke = dVar.a.invoke(producerScope, continuation);
