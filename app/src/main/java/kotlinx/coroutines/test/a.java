...
public final class a implements Comparable<a>, Runnable, ThreadSafeHeapNode {
    ...
    public int compareTo(@NotNull a aVar) {
        ...
        long j2 = aVar.a;
        if (j == j2) {
            return Intrinsics.compare(this.c, aVar.c);
        }
