...
public final class TableInfo {
    ...
    public static TableInfo read(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        return new TableInfo(str, b(supportSQLiteDatabase, str), a(supportSQLiteDatabase, str), c(supportSQLiteDatabase, str));
    }

    private static Set<ForeignKey> a(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
    ...
    @Nullable
    private static Set<Index> c(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            ...
            if (!(columnIndex == -1 || columnIndex2 == -1 || columnIndex3 == -1)) {
                HashSet hashSet = new HashSet();
                while (query.moveToNext()) {
                    if (ai.aD.equals(query.getString(columnIndex2))) {
                        String string = query.getString(columnIndex);
                        boolean z = true;
    ...
    public static final class Column {
        ...
        public boolean equals(Object obj) {
            ...
            int i = this.a;
            return (i == 0 || i != column.a || ((str = this.defaultValue) == null ? column.defaultValue == null : str.equals(column.defaultValue))) && this.affinity == column.affinity;
        }
