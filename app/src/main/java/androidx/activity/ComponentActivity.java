...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements OnBackPressedDispatcherOwner, ContextAware, ActivityResultCaller, ActivityResultRegistryOwner, HasDefaultViewModelProviderFactory, LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner {
    ...
    public ComponentActivity() {
        ...
        if (getLifecycle() != null) {
            ...
            getSavedStateRegistry().registerSavedStateProvider(ACTIVITY_RESULT_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.activity.-$$Lambda$ComponentActivity$cMYP7ohgYL-ejVFh55G_OXpU1T8
                @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
                public final Bundle saveState() {
                    return ComponentActivity.lambda$new$0(ComponentActivity.this);
                }
            });
            addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.activity.-$$Lambda$ComponentActivity$fIW3HeXLkhR_J1a4KKTuW3yI7Ak
                @Override // androidx.activity.contextaware.OnContextAvailableListener
                public final void onContextAvailable(Context context) {
                    ComponentActivity.lambda$new$1(ComponentActivity.this, context);
                }
            });
            return;
        }
    ...
    public static /* synthetic */ Bundle lambda$new$0(ComponentActivity componentActivity) {
        Bundle bundle = new Bundle();
        componentActivity.mActivityResultRegistry.onSaveInstanceState(bundle);
        return bundle;
    }

    public static /* synthetic */ void lambda$new$1(ComponentActivity componentActivity, Context context) {
