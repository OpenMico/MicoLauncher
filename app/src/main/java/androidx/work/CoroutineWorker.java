...
public abstract class CoroutineWorker extends ListenableWorker {
    ...
    @NotNull
    private final CoroutineDispatcher c = Dispatchers.getDefault();
    ...
    public final ListenableFuture<ListenableWorker.Result> startWork() {
        e.a(CoroutineScopeKt.CoroutineScope(getCoroutineContext().plus(this.a)), null, null, new a(null), 3, null);
        return this.b;
    }
