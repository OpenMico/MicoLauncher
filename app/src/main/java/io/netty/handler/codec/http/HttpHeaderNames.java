...
public final class HttpHeaderNames {
    ...
    public static final AsciiString AUTHORIZATION = new AsciiString(Common.AUTHORIZATION);
    public static final AsciiString CACHE_CONTROL = new AsciiString(Common.CACHE_CONTROL);
    ...
    public static final AsciiString CONTENT_ENCODING = new AsciiString(Common.CONTENT_ENCODING);
    ...
    public static final AsciiString CONTENT_MD5 = new AsciiString(Common.CONTENT_MD5);
    public static final AsciiString CONTENT_RANGE = new AsciiString(Common.CONTENT_RANGE);
    ...
    public static final AsciiString DATE = new AsciiString(Common.DATE);
    ...
    public static final AsciiString LAST_MODIFIED = new AsciiString(Common.LAST_MODIFIED);
    ...
    public static final AsciiString RANGE = new AsciiString(Common.RANGE);
