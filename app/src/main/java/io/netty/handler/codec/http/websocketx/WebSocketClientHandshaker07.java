...
public class WebSocketClientHandshaker07 extends WebSocketClientHandshaker {
    ...
    private static final InternalLogger a = InternalLoggerFactory.getInstance(WebSocketClientHandshaker07.class);
    private String b;
    ...
    protected FullHttpRequest newHandshakeRequest() {
        ...
        if (a.isDebugEnabled()) {
            a.debug("WebSocket version 07 client handshake key: {}, expected response: {}", c, this.b);
        }
    ...
    protected WebSocketFrameDecoder newWebsocketDecoder() {
        return new WebSocket07FrameDecoder(false, this.c, maxFramePayloadLength(), this.e);
    }

    @Override // io.netty.handler.codec.http.websocketx.WebSocketClientHandshaker
    protected WebSocketFrameEncoder newWebSocketEncoder() {
        return new WebSocket07FrameEncoder(this.d);
    }
}
