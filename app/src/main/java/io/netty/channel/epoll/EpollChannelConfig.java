...
public class EpollChannelConfig extends DefaultChannelConfig {
    ...
    public EpollMode getEpollMode() {
        return this.a.c(Native.EPOLLET) ? EpollMode.EDGE_TRIGGERED : EpollMode.LEVEL_TRIGGERED;
    }
        ...
        if (epollMode != null) {
            try {
                switch (epollMode) {
                    case EDGE_TRIGGERED:
                        a();
                        this.a.a(Native.EPOLLET);
                        break;
                    case LEVEL_TRIGGERED:
                        a();
                        this.a.b(Native.EPOLLET);
                        break;
                    default:
                        throw new Error();
                }
