...
public final class CompletableUsing<R> extends Completable {
    ...
    protected void subscribeActual(CompletableObserver completableObserver) {
        try {
            R r = this.a.get();
            try {
                ((CompletableSource) Objects.requireNonNull(this.b.apply(r), "The completableFunction returned a null CompletableSource")).subscribe(new a(completableObserver, r, this.c, this.d));
            } catch (Throwable th) {
