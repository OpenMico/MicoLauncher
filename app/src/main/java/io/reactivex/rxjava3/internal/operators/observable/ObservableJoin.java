                        ...
                        if (num == a) {
                            ...
                            try {
                                ...
                                for (TRight tright : this.rights.values()) {
                                    try {
                                        observer.onNext((Object) Objects.requireNonNull(this.resultSelector.apply(poll, tright), "The resultSelector returned a null value"));
                                    } catch (Throwable th) {
                            ...
                            try {
                                ...
                                for (TLeft tleft : this.lefts.values()) {
                                    try {
                                        observer.onNext((Object) Objects.requireNonNull(this.resultSelector.apply(tleft, poll), "The resultSelector returned a null value"));
                                    } catch (Throwable th3) {
