...
public final class FlowableFlatMapCompletableCompletable<T> extends Completable implements FuseToFlowable<T> {
    ...
    static final class a<T> extends AtomicInteger implements FlowableSubscriber<T>, Disposable {
        ...
        void a(a<T>.C0287a aVar) {
            this.set.delete(aVar);
            onComplete();
        }

        void a(a<T>.C0287a aVar, Throwable th) {
            this.set.delete(aVar);
            onError(th);
        }
        ...
        /* loaded from: classes5.dex */
        final class C0287a extends AtomicReference<Disposable> implements CompletableObserver, Disposable {
