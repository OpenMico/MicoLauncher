...
public final class ParallelMapTryOptional<T, R> extends ParallelFlowable<R> {
    ...
    static final class b<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        b(Subscriber<? super R> subscriber, Function<? super T, Optional<? extends R>> function, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
            this.a = subscriber;
            this.b = function;
            this.c = biFunction;
        }
    ...
    static final class a<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        a(ConditionalSubscriber<? super R> conditionalSubscriber, Function<? super T, Optional<? extends R>> function, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
