...
public final class ObservableConcatMap<T, U> extends a<T, U> {
    ...
    static final class a<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        a(Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> function, int i, boolean z) {
            ...
            this.bufferSize = i;
            this.tillTheEnd = z;
            this.observer = new C0320a<>(observer, this);
        }
        ...
        /* loaded from: classes5.dex */
        public static final class C0320a<R> extends AtomicReference<Disposable> implements Observer<R> {
            private static final long serialVersionUID = 2620149119579502636L;
            final Observer<? super R> downstream;
            final a<?, R> parent;

            C0320a(Observer<? super R> observer, a<?, R> aVar) {
                this.downstream = observer;
                this.parent = aVar;
            }
