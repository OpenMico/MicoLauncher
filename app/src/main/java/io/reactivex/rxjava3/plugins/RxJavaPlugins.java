...
public final class RxJavaPlugins {
    ...
    @Nullable
    static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> c;
    @Nullable
    static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> d;
    @Nullable
    static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> e;
    @Nullable
    static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> f;
    @Nullable
    ...
    @NonNull
    static Scheduler a(@NonNull Supplier<Scheduler> supplier) {
        try {
    ...
    @NonNull
    static Scheduler a(@NonNull Function<? super Supplier<Scheduler>, ? extends Scheduler> function, Supplier<Scheduler> supplier) {
        return (Scheduler) Objects.requireNonNull(a((Function<Supplier<Scheduler>, Object>) function, supplier), "Scheduler Supplier result can't be null");
    }
