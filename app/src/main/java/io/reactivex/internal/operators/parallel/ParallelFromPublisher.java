    ...
    static final class a<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        void a() {
            ...
            while (i < length && !this.cancelled) {
                ...
                subscriberArr[i].onSubscribe(new C0271a(i, length));
                i = i2;
            }
        }
        ...
        /* loaded from: classes4.dex */
        public final class C0271a implements Subscription {
            final int a;
            final int b;
        ...
        */
        void b() {
            ...
            L_0x00b3:
                ...
                goto L_0x0011
            */
            throw new UnsupportedOperationException("Method not decompiled: io.reactivex.internal.operators.parallel.ParallelFromPublisher.a.b():void");
        }
