...
public abstract class Random {
    ...
    private static final Random a = PlatformImplementationsKt.IMPLEMENTATIONS.defaultPlatformRandom();
    ...
    public long nextLong(long j, long j2) {
        ...
        if (j5 > 0) {
            if (((-j5) & j5) == j5) {
                ...
                int i2 = (int) (j5 >>> 32);
                if (i != 0) {
                    j3 = nextBits(RandomKt.fastLog2(i)) & 4294967295L;
                } else if (i2 == 1) {
    ...
    */
    ...
    public static final class Default extends Random implements Serializable {
        ...
        public byte[] nextBytes(@NotNull byte[] array) {
            Intrinsics.checkNotNullParameter(array, "array");
            return Random.a.nextBytes(array);
        }
        ...
        public byte[] nextBytes(@NotNull byte[] array, int i, int i2) {
            Intrinsics.checkNotNullParameter(array, "array");
            return Random.a.nextBytes(array, i, i2);
        }
    }
}
