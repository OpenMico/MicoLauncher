...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class a extends TimeMark {
        ...
        public long mo1664elapsedNowUwyO8pc() {
            return Duration.m1701minusLRDsOJo(DurationKt.toDuration(this.b.read() - this.a, this.b.getUnit()), this.c);
        }
        ...
        public TimeMark mo1665plusLRDsOJo(long j) {
            return new a(this.a, this.b, Duration.m1702plusLRDsOJo(this.c, j));
        }
    }
    ...
    public TimeMark markNow() {
        return new a(read(), this, Duration.Companion.m1726getZEROUwyO8pc(), null);
    }
}
